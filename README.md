...
**AI Summary — one email, analyzed by the local LLM (summary · actions · deadlines · category · risk · entities):**

![AI Summary](docs/post/app_4_ai_summary.png)

| Dashboard home | LLM Settings (local model) |
|---|---|
| ![Home](docs/post/app_1_home.png) | ![LLM Settings](docs/post/app_2_llm_settings.png) |

> _Real captures of the running Streamlit app with Llama 3 via Ollama._
